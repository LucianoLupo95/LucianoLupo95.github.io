...
const defaultImage = "https://img.wattpad.com/cover/110229305-256-k742352.jp";
imageToPick.src = defaultImage;
const buttonCojer = document.querySelector("#button-cojer");
...
const imageCojer = document.querySelector("#img-cojer");
...
const selectOption = (boolean, image)=>{
    ...
    if (options.casar && options.cojer && options.matar){
...
buttonCojer.addEventListener('click',() => selectOption("cojer", imageCojer));
